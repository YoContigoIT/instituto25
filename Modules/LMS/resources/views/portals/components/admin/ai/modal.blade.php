...
@endphp
<div id="ai-content-modal-btn-wrapper"
    class="fixed top-1/4 right-0 rtl:right-auto rtl:left-0 translate-x-[98px] rtl:-translate-x-[98px] hover:translate-x-0 z-backdrop duration-200 hidden">
    <button type="button"
        class="ai-content-modal-btn flex-center gap-3.5 bg-primary text-white duration-300 rounded-l-lg rtl:rounded-l-none rtl:rounded-r-lg shadow-md"
        aria-label="Ai content generate button">
        ...
        <span id="ai-content-modal-btn-dragger"
            class="flex-center pr-3.5 py-2 cursor-move">{{ translate('AI Content') }}</span>
    </button>
</div>
