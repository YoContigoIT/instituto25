...
<div class="relative pt-24 pb-48 overflow-hidden bg-primary-50 xl:pt-40 xl:pb-80">
                    ...
                    <div class="swiper-slide">
                        <div class="grid grid-cols-12 gap-7">
                            <div class="col-span-full lg:col-span-7">
                                <div class="area-subtitle subtitle-outline">
                                    {{ $translations['sub_title'] ?? ($slider->sub_title ?? '') }}</div>
                                @if ($title)
                            ...
                            <div class="items-center hidden col-span-full lg:col-span-5 lg:flex">
    ...
    @if ($socials)
        <div
            ...
            <div class="font-bold leading-none text-heading dark:text-white"> {{ translate('Follow Us') }} -</div>
            <x-theme::social.social-list-one :socials="$socials" ulClass="flex items-center gap-2"
